...
<body dir="rtl">
  ...
  font-weight: 700;
  src: url(iranSans/IRANSansWeb_Bold.woff);
}
@font-face {
  font-family: iransans;
  font-weight: medium;
  src: url(iranSans/IRANSansWeb.woff);
}
@font-face {
  font-family: iransans;
  font-weight: 300;
  src: url(iranSans/IRANSansWeb_Light.woff);
}
@font-face {
  font-family: iransans;
  font-weight: lighter;
  src: url(iranSans/IRANSansWeb_UltraLight.woff);
}
*{
  font-family: iransans
}
...
<header dir="ltr" class="bg-white">
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 bg-sky-500  " aria-label="Global">
...
<!-- منوی پرتابل -->
<div id="dropdown" dir="rtl" class="absolute top-full -left-8 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white ring-1 shadow-lg ring-gray-900/5 hidden">
    <!-- محتویات منو -->
    <div class="p-4">
    ...
    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
      <a href="#" class="text-sm/6 font-semibold text-black lg:text-white " > دارک</a>
    </div>
  </nav>
...
<h2 class="lg:text-3xl text-2xl m-4.5 ">دوره ها</h2>
<div class="doreHa mt-1.5 p-5.5 flex gap-5 flex-wrap justify-center">
  <div class="dore mt-3.5  flex flex-col gap-2.5 bg-gradient-to-l from-sky-500 to-blue-500 rounded-lg w-fit p-2 justify-center">
    <img class="w-60 h-40 rounded-md " src="https://th.bing.com/th/id/R.ce6aa844a8817ce6289b548ded0b5f12?rik=o%2fpOyJbMKpY3yQ&riu=http%3a%2f%2fupload.wikimedia.org%2fwikipedia%2fcommons%2f2%2f20%2fMonarch_Butterfly_resting_on_fennel%2c_at_the_Pismo_Butterfly_Grove%2c_California.jpg&ehk=RFpuej%2bDcXKdCBae5pWRKIFrGnHxKCa5xFQIGmm2s7k%3d&risl=&pid=ImgRaw&r=0" alt="">
    <h2 class="text-xl">نام دوره</h2>
    <p>این بخش توضیحات است</p>
    <p>قیمت :</p>
    <p>مدرس :</p>
    <a href="#" class="text-center">
      <button class="font-bold  text-blue-200 mt-5 hover:text-blue-800 " >
        مشاهده و خرید
      </button>
    </a>
  </div>
