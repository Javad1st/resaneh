    ...
    if (empty($email) || empty($password)) {
        ...
        if ($admin) {
            if (password_verify($password, $admin['password'])) {
                ...
                setcookie('logged_in', 'true', time() + 3600, '/resaneh/admin-fani'); // 1 ساعت اعتبار
...
<body>
    <div class="container">
        ...
        <form method="POST">
            ...
            <button style="font-weight: bolder;" type="submit">ورود</button>
        </form>
    </div>
</body>
</html>
