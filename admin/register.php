...
try {
    // دریافت اطلاعات ثبت‌نام‌های دوره‌ها از دیتابیس
    $stmt = $conn->prepare("SELECT * FROM course_registrations");
    $stmt->execute();
...
<head>
    ...
    <title>لیست ثبت‌نام‌های دوره‌ها</title>
...
<?php 
    ...
    <div class="container" dir="rtl">
        <h2>لیست ثبت‌نام‌های دوره‌ها رسانه</h2>
